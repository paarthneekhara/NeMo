...
manifest_path = "/datap/misc/speechllm_codecdatasets/manifests/LRHM_train_nemo_codec_bw_6.0_phoneme_tts_low_similarity.json"
...
with torch.no_grad():
    for ridx, record in enumerate(records):
        ...
        for cidx in range(len(codec_paths)):
            ...
            codec_decoded_audio_path = os.path.join("/datap/misc/decodingtesting/listening_{}={}.wav".format(ridx, cidx))
