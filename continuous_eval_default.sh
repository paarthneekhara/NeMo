...
EXP_NAMES=(
    ...
    # "newcode_LRHM_decodercontext1e-4_FromScratchLargeScale"
    # "newcode_LRHM_decodercontext1e-4"
    # "lrhm_mixed_answercontext_decodercontext"
    "newcode_LRHM_decodercontext1e-4"
    "newcode_LRHM_decodercontext_nopriorctc1e-4"
    "newcode_LRHM_decodercontext1e-4_onlyPrior"
    # "CTC_0.05_All_Data_PS_lr5e-5_Parallel_8k_to_15k"
    # "newcode_LRHM_encodercontext1e-4_onlyPrior"
    # "LRHM_noPriornoCTC"
    # "oldcodeEncodec_LRHM_encodercontext5e-5"
    # "oldcodeDac_LRHM_encodercontext1e-4_LongPrior"
    # "CTC_0.05_All_Data_PS_lr5e-5_Parallel_8k_to_15k_step238256"
    # "lrhm_corrected_sameanswercontext_decodercontext"
...
TEST_DSS=(
    # "/datap/misc/speechllm_codecdatasets/manifests/ellav_nemo_codec_phoneme.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/ellav_nemo_codec_phoneme.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/ellav_nemo_codec_phoneme.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/ellav_nemo_codec_phoneme.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/ellav_nemo_codec_phoneme.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/harvard_nemo_codec_phoneme.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/harvard_nemo_codec_phoneme.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/harvard_nemo_codec_phoneme.json"
    ...
    # "/datap/misc/speechllm_codecdatasets/manifests/challenging_nemo_codec.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/challenging_nemo_codec.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/LibriValOrig_encodec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    "/datap/misc/speechllm_codecdatasets/manifests/LibriValOrig_dac_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/LibriValOrig_nemo_codec_bw_6.0_phoneme_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/noisecontextsVCTKtext_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/cilentcontextsVCTKtext_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/LibriValOrig_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/LibriValOrig_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/smallvctk_nemo_codec_bw_6.0_phoneme_tts.json"
    "/datap/misc/speechllm_codecdatasets/manifests/smallvctk_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/smallvctk_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/LibriValOrig_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/LibriValOrig_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
    # "/datap/misc/speechllm_codecdatasets/manifests/LibriValOrig_nemo_codec_bw_6.0_phoneme_plus_sentencepiece_tts.json"
...
FIXED_CHECKPOINTS=(
    ...
    # "newcode_LRHM_decodercontext1e-4_step106263"
    # "newcode_LRHM_decodercontext1e-4_step126795"
    # "newcode_LRHM_decodercontext1e-4_step69878"
    # "newcode_LRHM_decodercontext1e-4_step69878"
    # "droplast_EnglishCheckpoint_ctc_sp_LRHM_nemocodec_8to15_step259875"
    # "newcode_LRHM_decodercontext1e-4_FromScratchLargeScale_step48285"
    # "none"
    # "none"
    # "none"
    "newcode_LRHM_decodercontext1e-4_step294116"
    "newcode_LRHM_decodercontext_nopriorctc1e-4_step256751"
    "newcode_LRHM_decodercontext1e-4_onlyPrior_step267483"
    # "CTC_0.05_All_Data_PS_lr5e-5_Parallel_8k_to_15k_step238256"
    # "newcode_LRHM_encodercontext1e-4_onlyPrior_step246772"
    # "LRHM_noPriornoCTC_step202000"
    # "oldcodeEncodec_LRHM_encodercontext5e-5_step247560"
    # "oldcodeDac_LRHM_encodercontext1e-4_LongPrior_step82155"
    # "CTC_0.05_All_Data_PS_lr5e-5_Parallel_8k_to_15k_step238256"
...
if [ "$CODEC_MODEL_TYPE" = "nemo_codec" ]; then
    ...
    if [ "$CODEC_MODEL_TYPE" = "dac" ]; then
        ...
        CODEC_MODEL_PATH="/datap/misc/Checkpoints/dac/weights_44khz_8kbps_0.0.1.pth"
    else
        CODEC_FPS=75
        CODEC_MODEL_CODEBOOKS=8
    fi
...
echo "CODEC_MODEL_TYPE: $CODEC_MODEL_TYPE"
echo "CODEC_FPS: $CODEC_FPS"
echo "CODEC_MODEL_CODEBOOKS: $CODEC_MODEL_CODEBOOKS"
...
exp_manager.exp_dir=/datap/misc/ContinuousEval/Feb27/ChallengingPhonemeTTSDecoderContextFinal \
...
+model.codecmodel_path=$CODEC_MODEL_PATH \
trainer.devices=1 \
...
--exp_base_dir /datap/misc/ContinuousEval/Feb27/ChallengingPhonemeTTSDecoderContextFinal \
